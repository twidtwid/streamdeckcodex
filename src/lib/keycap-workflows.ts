...
export const KEYCAP_WORKFLOWS: readonly WorkflowDefinition[] = [
  ...
  workflow(
    ...
    "New project",
    "folder-plus",
    "Help create the requested new project in the current workspace. Establish a clean structure, documented development workflow, tests, and a verified first working version.",
    "#9CD5FE",
  ),
  workflow(
    "upload",
    "Upload",
    "cloud-upload",
    "Identify exactly what the current task intends to upload and to which destination. Validate the artifact and destination, then perform the upload only when both are unambiguous and authorized.",
    "#9CD5FE",
  ),
  workflow(
    "sessions",
  ...
  workflow(
    ...
    "Tune setup",
    "settings",
    "Inspect the current project's and Codex companion's relevant settings. Explain the effective configuration and make only the specific safe adjustment required by the active task.",
  ),
] as const;
